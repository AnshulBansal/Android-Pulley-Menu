        ...
        if (USE_TRANSLATIONS) {
            ...
            switch (mPosition) {
                ...
                case BOTTOM:
                    ...
                    Log.d("Trueoffset " + offsetPixels,"ContentContiner top " +mContentContainer.getTop());
                    break;
...
//
  //              } else {
               Log.d("menucontainer " +mMenuContainer.getTop(),"offset " + offset);
               
                    mMenuContainer.offsetTopAndBottom(offset - mMenuContainer.getBottom());
